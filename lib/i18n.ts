...
export const messages = {
  it: {
    ...
    shell: {
      ...
      enableMotion: "Attiva le animazioni",
      disableMotion: "Riduci le animazioni",
      motionOn: "Animazioni attive",
      motionOff: "Movimento ridotto",
      ...
      madonninaAction: "Fai brillare la Madonnina",
  ...
  en: {
    ...
    shell: {
      ...
      disableMotion: "Reduce animations",
      ...
      madonninaAction: "Make the Madonnina shine",
